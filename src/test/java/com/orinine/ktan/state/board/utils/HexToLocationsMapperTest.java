...
public class HexToLocationsMapperTest {
    ...
    public void testZeroOneHexToPoints() {
        ...
        assert(locations.get(0).equals(new Point(1, 2)));
        assert(locations.get(1).equals(new Point(0, 3)));
        assert(locations.get(2).equals(new Point(1, 3)));
        assert(locations.get(3).equals(new Point(0, 4)));
        assert(locations.get(4).equals(new Point(1, 4)));
        assert(locations.get(5).equals(new Point(1, 5)));
    }
    ...
    public void testOneOneHexToPoints() {
        ...
        assert(locations.get(0).equals(new Point(2, 2)));
        assert(locations.get(1).equals(new Point(1, 3)));
        assert(locations.get(2).equals(new Point(2, 3)));
        assert(locations.get(3).equals(new Point(1, 4)));
        assert(locations.get(4).equals(new Point(2, 4)));
        assert(locations.get(5).equals(new Point(2, 5)));
    }
    ...
    public void testTwoOneHexToPoints() {
        ...
        assert(locations.get(0).equals(new Point(3, 2)));
        assert(locations.get(1).equals(new Point(2, 3)));
        assert(locations.get(2).equals(new Point(3, 3)));
        assert(locations.get(3).equals(new Point(2, 4)));
        assert(locations.get(4).equals(new Point(3, 4)));
        assert(locations.get(5).equals(new Point(3, 5)));
    }
    ...
    public void testZeroTwoHexToPoints() {
        ...
        assert(locations.get(0).equals(new Point(0, 4)));
        assert(locations.get(1).equals(new Point(0, 5)));
        assert(locations.get(2).equals(new Point(1, 5)));
        assert(locations.get(3).equals(new Point(0, 6)));
        assert(locations.get(4).equals(new Point(1, 6)));
        assert(locations.get(5).equals(new Point(0, 7)));
    }
    ...
    public void testOneTwoHexToPoints() {
        ...
        assert(locations.get(3).equals(new Point(1, 6)));
        assert(locations.get(4).equals(new Point(2, 6)));
        assert(locations.get(5).equals(new Point(1, 7)));
    }
    ...
    public void testTwoTwoHexToPoints() {
        ...
        assert(locations.get(0).equals(new Point(2, 4)));
        assert(locations.get(1).equals(new Point(2, 5)));
        assert(locations.get(2).equals(new Point(3, 5)));
