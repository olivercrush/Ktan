...
public class BoardToJsonConverterTest {
    ...
    public void toJson() throws IOException {
        var expectedJson = new String(classLoader.getResource("com/orinine/ktan/state/board/json/simpleBoard.json").openStream().readAllBytes());
        ...
        assertEquals(expectedJson, BoardToJsonConverter.toJsonWithPrettyPrinting(board));
    }
